...
layout(set = 0, binding = 0, rgba32f) restrict uniform image2D cells_in;
layout(set = 0, binding = 1, rgba32f) restrict uniform image2D cells_out;
layout(set = 0, binding = 2, rgba32f) restrict uniform image2D ring;
